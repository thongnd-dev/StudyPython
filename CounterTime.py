...
window.title('Counter timer')  # giving title
Label(window, text="Countdown Clock and Timer", font=('Tahoma')).pack(pady=20)
...
Label(window, text="Enter time in HH:MM:SS", font=('Tahoma')).pack()
